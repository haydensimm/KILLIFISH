...
```{r}
#GROUP1
df_killifish_respirometry_acclimation_group1 <- read_delim("KILLIFISH_RESPIROMETRY_ACCLIMATION_GROUP1.txt")
df_background_respirometry_acclimation_group1 <- read_delim("KILLIFISH_RESPIROMETRY_ACCLIMATION_GROUP1.txt")
df_killifish_respirometry_opposite_group1 <- read_delim("KILLIFISH_RESPIROMETRY_OPPOSITE_GROUP1.txt")
df_background_respirometry_opposite_group1 <- read_delim("KILLIFISH_RESPIROMETRY_OPPOSITE_GROUP1.txt")
